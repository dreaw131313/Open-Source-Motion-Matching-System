...
{
    [System.Serializable]
    public class MotionMatchingData : ScriptableObject, ISerializationCallbackReceiver
    {
        //[SerializeField]
        ...
        public Vector3[] animationSeqInfos;
        #endregion

        #region Trajectory calculation fields
        //[SerializeField]
        //public Vector3 endLocalPosition;
        //[SerializeField]
        //public Quaternion deltaRotStartEnd;
        //[SerializeField]
        //public Vector3 startLocalPosition;
        //[SerializeField]
        //public Quaternion deltaRotEndStart;
        //[SerializeField]
        ...
        #region Sections
        [SerializeField]
        public List<MM_DataSection> sections;
        [SerializeField]
        public MM_DataSection neverChecking;
        [SerializeField]
        public MM_DataSection notLookingForNewPose;
        [SerializeField]
        ...
        [SerializeField]
        public Quaternion fromFirstToSecondContactRot;
        #endregion

        #region
        [SerializeField]
        public List<MotionMatchingEventMarker> eventMarkers = new List<MotionMatchingEventMarker>();
        #endregion

        #region Properties 
        public Dictionary<string, int> sectionIndexes { get; private set; }
        ...
        public void OnLogicStateCreation()
        {
            userCount++;
            if (userCount > 1)
            {
            ...
            {
                sectionIndexes.Add(sections[i].sectionName, i);
            }


            eventMarkers.Sort(delegate (MotionMatchingEventMarker x, MotionMatchingEventMarker y)
            {
        ...
        */
        ...
        #region Section
        public MM_DataSection GetSection(string name)
        {
            return sections[sectionIndexes[name]];
        }

        public MM_DataSection GetSection(int index)
        {
        ...
        public int GetEventMarkersCount()
        {
            return eventMarkers.Count;
        }
        #endregion

        #region Callback reciver
