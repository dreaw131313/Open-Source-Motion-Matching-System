    ...
    public static class GUIResources
    {
        ...
        public static GUIStyle NormalNodeStyle()
        {
            if (normalNode == null)
            {
                ...
                normalNode.normal.background = EditorGUIUtility.Load("builtin skins/darkskin/images/node1.png") as Texture2D;
        ...
        public static GUIStyle StartNodeStyle()
        {
            if (startNode == null)
            {
                ...
                startNode.normal.background = EditorGUIUtility.Load("builtin skins/darkskin/images/node5.png") as Texture2D;
